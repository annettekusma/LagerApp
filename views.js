...
var views = (function () {
	...
	window.mainContainer.className = "home";
	console.log("cleansed mainContainer.innerHTML");
	...
	window.mainContainer.innerHTML = "";
	window.mainContainer.className = "about";
	...
	window.mainContainer.innerHTML = "";
	window.mainContainer.className = "repos";
	console.log("made mainContainer.innerHTML");
	...
	window.mainContainer.innerHTML = "";
	window.mainContainer.className = "prens";
